...
struct DemoURL {
    static let Stanford = URL(string: "https://s3-us-west-2.amazonaws.com/insideiim/wp-content/uploads/2016/05/26014711/stanford-campus.png")
...
//        static let Cassini = URL(string: "http://forum.celestialmatters.org/userpix/7_cassini_1.jpg")
//        static let Earth = URL(string: "https://saturn.jpl.nasa.gov/system/resources/detail_files/5868_IMG004868.jpg")
//        static let Saturn = URL(string: "http://apod.nasa.gov/apod/image/0901/newrings_cassini_big.jpg")
    }
}
